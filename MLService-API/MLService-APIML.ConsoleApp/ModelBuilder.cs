...
{
    private static string TRAIN_DATA_FILEPATH = @"D:\Downloads\sentiment labelled sentences\sentiment labelled sentences\amazon_cells_labelledCopy.tsv";
    private static string MODEL_FILEPATH = @"../../../../MLServiceAPIML.Model/MLModel.zip";
    ...
    {
        // Load Data
        IDataView trainingDataView = mlContext.Data.LoadFromTextFile<NewsArticleSentimentAnalysisModelInput>(
